...
#define MOD_1_PIN_UART_IMU_RX    P6_4
#define MOD_1_PIN_UART_IMU_TX    P6_5

/* SPI Pins */
#define MOD_1_PIN_SPI_MOSI   P9_0
#define MOD_1_PIN_SPI_MISO   P9_1
#define MOD_1_PIN_SPI_SCLK   P9_2
#define MOD_1_PIN_SPI_CS_N   P9_4

/* Generic IO Pins */
#define MOD_1_PIN_IO_BUTTON       P9_5
#define MOD_1_PIN_IO_IMU_nRESET       P5_2
#define MOD_1_PIN_IO_IMU_INT       P5_3

/* Analog Pins */
#define MOD_1_PIN_PWM      P10_2
