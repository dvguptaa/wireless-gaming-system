...
void task_console_rx(void *param)
{
    ...
    while (1)
    {
        ...
        /*
         * FIX: Check if the input index is 0 (i.e., an empty string).
         * This handles the case where the terminal sends \r and \n separately.
         * We just ignore the empty command.
         */
        if(cInputIndex == 0)
        {
            ...
            /* Continue to the next loop iteration to wait for a notification */
            continue;
        }
